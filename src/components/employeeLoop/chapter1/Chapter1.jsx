...
export default function Chapter1() {
  ...
  useEffect(() => {
    if (currentLine === 2) { // เมื่อถึงบรรทัดที่ 3 (index 2)
      ...
      <div className="chapter1-detail">
        <div className="detail-text">
          ...
          {isNextEnabled && currentLine < content.length - 1 && (
            <button className="btn-chapter1" onClick={handleNextLine}>ถัดไป</button>
          )}
          ...
          {showInput ? <div>
            ...
            <button style={{color: 'rgb(35, 129, 245)'}} onClick={handleNext} className="btn-chapter1">ถัดไป</button>
          </div>: ""}
        </div>
      </div>
    </div>
